...
def text_to_speech(text: str, user_lang: str = "en") -> bytes:
    speech_key = os.getenv("AZURE_SPEECH_KEY")
    service_region = os.getenv("AZURE_SPEECH_REGION", "westeurope")
    ...
    # Choose language by region
    # Here it is we could do settings for choose our special voice
    voice_name = LANGUAGE_VOICES.get(user_lang, "en-US-AriaNeural")
